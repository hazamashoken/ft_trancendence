...
export default function Game(props: any) {
  ...
  return (
    <div className='flex flex-col items-center'>
      ...
      <div className='flex flex-row items-center m-1'>
        <Button className='mt-1 mb-1 ml-4 mr-4' disabled={phase == Phase.waiting} onMouseDown={sendKeyUp} onMouseUp={sendKeyRelease}>↑</Button>
        <Button className='mt-1 mb-1 mr-4 mr-4' disabled={phase == Phase.waiting} onMouseDown={sendKeyDown} onMouseUp={sendKeyRelease}>↓</Button>
      </div>
