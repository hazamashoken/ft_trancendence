...
export class PongGame
{
  ...
  public deleteUser(id: string)
  {
    ...
    var room: string = this._users.get(id).room;
    // delete the user
  ...
  {
    var name: string = this._users.get(id).name;
  ...
  {
    var state: GameState = this._states.get(room).state();
  ...
  {
    var user: PongUser = this._users.get(id);
    var state: PongState = this._states.get(user.room);
